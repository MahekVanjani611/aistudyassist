...
import { type Note, type NoteCollection } from '@/lib/api'
...
interface NotesListProps {
  ...
  onAssignCollection?: (noteId: string, collectionId: string) => void
}

type SortOption = 'updated' | 'created' | 'title' | 'wordCount'
type SortDirection = 'asc' | 'desc'

export function NotesList({ notes, onEdit, onDelete, onSelect, onRefreshKeywords, selectedNoteId, collections = [], onAssignCollection }: NotesListProps) {
          ...
          <div className="flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                {onAssignCollection && collections.length > 0 && (
                  <>
                    <DropdownMenuSeparator />
                    {collections.slice(0, 8).map((collection) => (
                      <DropdownMenuItem
                        ...
                        onClick={(e: React.MouseEvent) => {
                          e.stopPropagation()
                          onAssignCollection(note.id, collection.id)
                        }}
                      >
